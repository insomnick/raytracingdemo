...
% Hier noch update
Für $k = 4$ schwanken die Werte bei Nutzung des k-way splittings und näheren sich für die größeren untersuchten Modelle 
Unter Nutzung des Collapsing-Verfahrens sind die Speedups deutlich wertstabiler. Hier lassen sich klare Negativtrends für den Median-Split und Positivtrends für SAH und BSAH ablesen. 
%Ab hier ok
...
\end{figure}
Zudem ist wichtig, dass der für $k = 4$ beobachtete Effekt zwar statistisch signifikant ist, aber trotzdem stark vom untersuchten Modell abhängt und maximal 10 Prozent beträgt. Die größte Optimierung geschieht bei Modellen mit ohnehin sehr kurzer Traversal-Time. Das heißt, dass Wide BVH in diesem linearen Zusammenhang eher als szenenabhäbgige Optimierung mit kleinem Effekt zu sehen ist. Zudem bringt die Nutzung von collapsing Wertstabilere Ergebnisse hervor. 
