...
Die Abbildung~\ref{fig:static} zeigt die Traversal-Speedup für $k \in {4, 8, 16}$ und Tabelle~\ref{tab:statistical} enthält die dazugehörigen Mittelwerte, Konfidenzintervalle und p-Werte für jede kombination von Szene, Splittingverfahren und Wide BVH Methode.
...
Die zweiten Forschungsfrage bezieht sich darauf, inwiefern sich die Traversal-Time der BVHs zwischen direktem k-way splitting und collapse einer binären BVH verändern.
