...
Für Teile des Entstehungsprozesses dieser Arbeit wurden Large-Language-Models (Sonnet 4.5, Opus 4.5, GPT 5.2) verwendet. Dies geschah im Rahmen von Programmierunterstützung und sprachlichen Glättung, sowie Strukturierung des schriftlichen Teils.
...
\begin{figure}[h]
    ...
    \caption{Traversal-Speedup für statische Szenen}
    \label{fig:static}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{results/rq1/hit_ray_analysis.png}
    \caption{AABB- und Triangle-Tests, Stanford Bunny, Median, collapse}
